...
namespace CludeMedSync.Api.Controllers
{
	...
	public class ProfissionaisController : ControllerBase
	{
		...
		[HttpPost]
		[ProducesResponseType(typeof(ResultadoOperacao<ProfissionalDto>), StatusCodes.Status201Created)]
		[ProducesResponseType(typeof(ResultadoOperacao<>), StatusCodes.Status400BadRequest)]
		public async Task<IActionResult> Create([FromBody] CreateProfissionalDto pacienteDto)
		{
			var resultado = await _profissionalService.CreateAsync(pacienteDto);
		...
		[ProducesResponseType(typeof(ResultadoOperacao<ProfissionalDto>), StatusCodes.Status400BadRequest)]
